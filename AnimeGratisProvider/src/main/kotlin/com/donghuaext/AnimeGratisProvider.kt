...
class AnimeGratisProvider : MainAPI() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val items = doc.select("div.items article, div.post-item, div.bs, div.anime-card").mapNotNull { it.toSearchResult() }
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        return doc.select("div.items article, div.post-item, div.bs, div.anime-card").mapNotNull { it.toSearchResult() }
    }
